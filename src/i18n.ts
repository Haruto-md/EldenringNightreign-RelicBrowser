...
const resources = {
  en: {
    translation: {
      ...
      character: "Character",
      changeSaveFileTooltip: "Change save file",
      ...
      removeGroupLabel: "Remove this group",
      ...
      presetsExportButton: "Export presets to file",
      presetsImportButton: "Import presets from file",
      presetsImportSuccess: "Imported {{count}} preset(s)",
      presetsImportError: "That file doesn't contain valid presets",
      ...
      showingAllRelicsTemplate:
        "Showing all {{total}} relics on character {{character}}",
      showingMatchingRelicsTemplate:
        "Showing {{matching}} matching relics out of {{total}} on character {{character}}",
      ...
      sellCandidatesShowSelectedOnly: "Show selected only",
  ...
  ja: {
    translation: {
      relicBrowserTab: "遺物ブラウザ",
      character: "キャラクター",
      changeSaveFileTooltip: "セーブファイルを変更",
      searchPlaceholder: "遺物名または効果で検索...",
      ...
      requiredGroupHint: "必須条件（各行：いずれか1つを満たす遺物）",
      addEffectPlaceholder: "効果を追加...",
      addGroupButton: "条件グループを追加",
      removeGroupLabel: "この条件グループを削除",
      excludedGroupHint: "除外条件（以下のいずれも持たない遺物）",
      ...
      presetsExportButton: "プリセットをファイルに書き出す",
      presetsImportButton: "ファイルからプリセットを読み込む",
      presetsImportSuccess: "{{count}}件のプリセットを読み込みました",
      presetsImportError: "有効なプリセットが含まれていないファイルです",
      ...
      outclassedText: "この遺物はより優れた遺物により不要になっています。",
      duplicateText: "この遺物は重複しています。",
      relicComparisonTitle: "遺物比較",
      closeButton: "閉じる",
      showingAllRelicsTemplate: "{{character}}の全{{total}}件の遺物を表示中",
      showingMatchingRelicsTemplate:
        "{{character}}の全{{total}}件中、条件に一致する{{matching}}件を表示中",
      sellCandidatesShowSelectedOnly: "選択済みのみ表示",
      nightfarers: {
